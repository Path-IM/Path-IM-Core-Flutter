...
final $typed_data.Uint8List sendMsgReqDescriptor = $convert.base64Decode(
    'CgpTZW5kTXNnUmVxEiUKB21zZ0RhdGEYASABKAsyCy5wYi5Nc2dEYXRhUgdtc2dEYXRh');
...
const MsgData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'clientTime', '3': 9, '4': 1, '5': 3, '10': 'clientTime'},
    const {'1': 'serverTime', '3': 10, '4': 1, '5': 3, '10': 'serverTime'},
...
final $typed_data.Uint8List msgDataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List msgOptionsDescriptor = $convert.base64Decode(
    'CgpNc2dPcHRpb25zEh4KCnBlcnNpc3RlbnQYASABKAhSCnBlcnNpc3RlbnQSGAoHaGlzdG9yeRgCIAEoCFIHaGlzdG9yeRIUCgVsb2NhbBgDIAEoCFIFbG9jYWwSLAoRdXBkYXRlVW5yZWFkQ291bnQYBCABKAhSEXVwZGF0ZVVucmVhZENvdW50Ei4KEnVwZGF0ZUNvbnZlcnNhdGlvbhgFIAEoCFISdXBkYXRlQ29udmVyc2F0aW9u');
...
const SendMsgResp$json = const {
  ...
  '2': const [
    ...
    const {'1': 'serverTime', '3': 6, '4': 1, '5': 3, '10': 'serverTime'},
  ],
};
...
final $typed_data.Uint8List sendMsgRespDescriptor = $convert.base64Decode(
    '');
