...
final $typed_data.Uint8List getMinAndMaxSeqReqDescriptor =
    $convert.base64Decode('ChJHZXRNaW5BbmRNYXhTZXFSZXE=');
...
final $typed_data.Uint8List getMinAndMaxSeqRespDescriptor = $convert.base64Decode(
    'ChNHZXRNaW5BbmRNYXhTZXFSZXNwEhYKBm1pblNlcRgBIAEoDVIGbWluU2VxEhYKBm1heFNlcRgCIAEoDVIGbWF4U2Vx');
...
final $typed_data.Uint8List getMinAndMaxGroupSeqReqDescriptor =
    $convert.base64Decode(
        'ChdHZXRNaW5BbmRNYXhHcm91cFNlcVJlcRIgCgtncm91cElETGlzdBgBIAMoCVILZ3JvdXBJRExpc3Q=');
...
final $typed_data.Uint8List getMinAndMaxGroupSeqRespDescriptor =
    $convert.base64Decode(
        'ChhHZXRNaW5BbmRNYXhHcm91cFNlcVJlc3ASQAoMZ3JvdXBTZXFMaXN0GAEgAygLMhwucGIuR2V0TWluQW5kTWF4R3JvdXBTZXFJdGVtUgxncm91cFNlcUxpc3Q=');
...
final $typed_data.Uint8List getMinAndMaxGroupSeqItemDescriptor =
    $convert.base64Decode(
        'ChhHZXRNaW5BbmRNYXhHcm91cFNlcUl0ZW0SGAoHZ3JvdXBJRBgBIAEoCVIHZ3JvdXBJRBIWCgZtaW5TZXEYAiABKA1SBm1pblNlcRIWCgZtYXhTZXEYAyABKA1SBm1heFNlcQ==');
