...
class SendMsgReq extends $pb.GeneratedMessage {
  ...
  factory SendMsgReq.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory SendMsgReq.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  SendMsgReq copyWith(void Function(SendMsgReq) updates) =>
      super.copyWith((message) => updates(message as SendMsgReq))
          as SendMsgReq; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static SendMsgReq getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SendMsgReq>(create);
...
class MsgData extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set conversationType($core.int v) {
...
class MsgOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set updateConversation($core.bool v) {
    $_setBool(4, v);
  }
...
class SendMsgResp extends $pb.GeneratedMessage {
  ...
  factory SendMsgResp.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory SendMsgResp.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SendMsgResp copyWith(void Function(SendMsgResp) updates) =>
      super.copyWith((message) => updates(message as SendMsgResp))
          as SendMsgResp; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  ...
  @$core.pragma('dart2js:noInline')
  static SendMsgResp getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SendMsgResp>(create);
